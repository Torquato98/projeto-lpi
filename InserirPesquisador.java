...
public class InserirPesquisador extends JFrame implements ActionListener{
   ...
   public InserirPesquisador(Connection conn){
   ...
   public void actionPerformed(ActionEvent e){
      if(e.getSource() == btnSalvar){
         ...
         boolean response = pesquisador.insert(this.conn);
         if(response){
