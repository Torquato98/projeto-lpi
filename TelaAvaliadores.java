...
public class TelaAvaliadores extends JFrame implements ActionListener, ListSelectionListener{
   ...
   public void actionPerformed(ActionEvent e){
      ...
      int i = JOptionPane.showOptionDialog(null, "Tem certeza que deseja excluir o Avaliador "+tabelaAvaliadores.getValueAt(tabelaAvaliadores.getSelectedRow(),1)+"?", "ATENÇÃO",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,null,null,null); 
