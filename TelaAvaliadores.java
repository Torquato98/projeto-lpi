...
public class TelaAvaliadores extends JFrame implements ActionListener, ListSelectionListener{
   ...
   private String[] colunas = {"ID","Nome", "Sexo", "RG", "CPF", "Data de Nascimento", "Grau de Conhecimento", "Institui��o", "Area de Pesquisa"};
   ...
   public void actionPerformed(ActionEvent e){
      if(e.getSource() == btnInserir){
         ...
         try{
            ...
            JOptionPane.showMessageDialog(this, "Voc� deve selecionar um item da tabela para alterar");
         }
      }
      ...
      int i = JOptionPane.showOptionDialog(null, "Tem certeza que deseja excluir o Avaliador "+tabelaAvaliadores.getValueAt(tabelaAvaliadores.getSelectedRow(),1)+"?", "ATEN��O",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,null,null,null); 
